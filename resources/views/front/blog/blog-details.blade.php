    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Post Content -->
                <p class="lead font-weight-bold">{{ $blog->blog_short_description }}</p>
                <hr>
            ...
            <div class="col-md-4">
              ...
              {{--</span>--}}
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias aliquam beatae consequatur dignissimos eaque enim, incidunt minima, molestiae mollitia numquam provident sit voluptas. Deserunt dignissimos distinctio fugiat itaque quisquam repudiandae.
                    </div>
                </div>
